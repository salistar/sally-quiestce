 ...
 * @description Création d'une room Qui Est-Ce. Sliders pour maxPlayers (2-10),
...
export default function CreateRoomScreen() {
  ...
  const handleCreate = async () => {
    setCreating(true);
    try {
      log.bin('POST /rooms', { gameType: 'quiestce', maxPlayers, isPrivate });
      const room = await api.createRoomFull('quiestce', { maxPlayers, isPrivate });
